...
If the remote decryption service is configured, the data can be accessed via

  plain_text = user.secret.decrypt_remotely

Note: This will make a request to the remote service with RestClient.
